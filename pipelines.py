...
def text_to_summary(
    ...
    # Update the model name to a valid one
    configSummary = OpenAICompletionAPI(api_key=api_key,
                                        model="gpt-4",  # Change this line to the valid model name
                                        max_tokens=777,
                                        temperature=0.5,
    ...
    # Call the summarize_transcription without the 'config' argument
    ...
    configMeetingSummary = OpenAICompletionAPI(api_key=api_key,
                                               model="gpt-4",  # Update the model name here too
                                               max_tokens=2000,
                                               messages=[{"role": "system", "content": "You are a helpful assistant."},
